...
class StoredClientChannel {
    ...
    StoredClientChannel(int majorVersion, Sha256Hash id, Transaction contract, Transaction refund, ECKey myKey, Coin valueToMe,
    ...
    public String toString() {
        ...
        return String.format(Locale.US, "Stored client channel for server ID %s (%s)%n" +
                ...
                "Refund:    %s" +
                "Close:     %s",
                id, active ? "active" : "inactive", majorVersion, myKey, valueToMe, refundFees,
